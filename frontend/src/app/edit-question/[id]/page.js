// frontend/src/app/edit-question/[id]/page.js
"use client";
          ...
          >
            <Box sx={{ borderBottom: `1px solid ${alpha(theme.palette.divider, 0.1)}`, bgcolor: alpha(theme.palette.background.default, 0.5) }}>
              <Tabs 
                ...
                scrollButtons="auto"
                sx={{ 
                  '& .MuiTab-root': { fontFamily: 'monospace', textTransform: 'none', minHeight: 48, fontWeight: 600 } 
                }}
              >
            ...
            <Box component="form" onSubmit={handleSubmit} sx={{ p: { xs: 2, md: 4 } }}>
                ...
                <Stack spacing={3}>
                  ...
                  <Box>
                    ...
                    <TextField
                      ...
                      sx={{ '& .MuiInputBase-root': { fontFamily: 'monospace', fontSize: '1rem' } }}
                      InputProps={{
                        startAdornment: (
              ...
              <Box sx={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between', alignItems: 'center', gap: 2 }}>
                ...
                <Box sx={{ display: 'flex', gap: 2, flexWrap: 'wrap', width: { xs: '100%', sm: 'auto' } }}>
                  ...
                  >
                    {loading ? "committing..." : "update changes"}
                  </Button>
                </Box>
              </Box>
