...
import {
  ...
  Collapse, CircularProgress, Alert, Fab
} from '@mui/material';
import { Search, ExpandMore, Add } from '@mui/icons-material';
    ...
    <Container maxWidth="lg" sx={{ py: 4 }}>
      <Box sx={{ mb: 4 }}>
        ...
        <Typography variant="body1" color="text.secondary">
          Browse through {questions.length} comprehensive interview questions
        </Typography>
      </Box>
